...
function wp_bootstrap_custom_admin_footer() {
	echo '<span id="footer-thankyou">Developed by <a href="http://okfn.org" target="_blank">Open Knowledge</a></span>. Built using <a href="http://320press.com" target="_blank">320press</a>.';
}
...
function wp_bootstrap_register_sidebars() {
    ...
    register_sidebar(array(
    	'id' => 'sidebar1',
    	'name' => 'Sidebar',
    	'description' => 'Used on every with the sidebar template.',

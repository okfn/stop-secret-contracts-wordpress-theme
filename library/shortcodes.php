...
function column_shortcode( $atts, $content = null ) {  
    ...
    $styles = '';
		...
		return '<div class="col-md-'.$span.' col-md-offset-'.$offset.' '.$class.'"'.$styles.'>' .do_shortcode($content). '</div>'; 
		}
...
function feed_shortcode( $atts, $content = null ) {
	extract( shortcode_atts( array(
	'url' => 'http://www.feedrinse.com/services/channel/?chanurl=68270c1a96a65491b7ef18c944d5f699',
	'count' => '3',
	'date' => 'DD MMMM YYYY', 
  'lang' => 'en',
  'id' => '1',
